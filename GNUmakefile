...
gcc_deps = $(all_sources:src/%=build/%.gcc.dep)
gcc_common_objs = $(all_common_sources:src/%=build/%.gcc.o)
gcc_main_objs = $(all_main_sources:src/%=build/%.gcc.o)
gcc_test_objs = $(all_test_sources:src/%=build/%.gcc.o)
gcc_d_deps = $(all_sources:src/%=build/%.gcc_d.dep)
gcc_d_common_objs = $(all_common_sources:src/%=build/%.gcc_d.o)
gcc_d_main_objs = $(all_main_sources:src/%=build/%.gcc_d.o)
gcc_d_test_objs = $(all_test_sources:src/%=build/%.gcc_d.o)

clang_deps = $(all_sources:src/%=build/%.clang.dep)
clang_common_objs = $(all_common_sources:src/%=build/%.clang.o)
clang_main_objs = $(all_main_sources:src/%=build/%.clang.o)
clang_test_objs = $(all_test_sources:src/%=build/%.clang.o)
clang_d_deps = $(all_sources:src/%=build/%.clang_d.dep)
clang_d_common_objs = $(all_common_sources:src/%=build/%.clang_d.o)
clang_d_main_objs = $(all_main_sources:src/%=build/%.clang_d.o)
clang_d_test_objs = $(all_test_sources:src/%=build/%.clang_d.o)

mingw_deps = $(win_all_sources:src/%=build/%.mingw.dep)
mingw_common_objs = $(win_all_common_sources:src/%=build/%.mingw.o)
mingw_main_objs = $(win_all_main_sources:src/%=build/%.mingw.o)
mingw_test_objs = $(win_all_test_sources:src/%=build/%.mingw.o)
mingw_d_deps = $(win_all_sources:src/%=build/%.mingw_d.dep)
mingw_d_common_objs = $(win_all_common_sources:src/%=build/%.mingw_d.o)
mingw_d_main_objs = $(win_all_main_sources:src/%=build/%.mingw_d.o)
mingw_d_test_objs = $(win_all_test_sources:src/%=build/%.mingw_d.o)

win_clang_deps = $(win_all_sources:src/%=build/%.win_gnu_clang.dep)
win_clang_common_objs = $(win_all_common_sources:src/%=build/%.win_gnu_clang.o)
win_clang_main_objs = $(win_all_main_sources:src/%=build/%.win_gnu_clang.o)
win_clang_test_objs = $(win_all_test_sources:src/%=build/%.win_gnu_clang.o)
win_clang_d_deps = $(win_all_sources:src/%=build/%.win_gnu_clang_d.dep)
win_clang_d_common_objs = $(win_all_common_sources:src/%=build/%.win_gnu_clang_d.o)
win_clang_d_main_objs = $(win_all_main_sources:src/%=build/%.win_gnu_clang_d.o)
win_clang_d_test_objs = $(win_all_test_sources:src/%=build/%.win_gnu_clang_d.o)
