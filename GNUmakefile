...
all: debug release debug-clang release-clang win-debug win-release $(test_targets)
...
win-all: win-debug win-release win-debug-clang win-release-clang $(win_test_targets)
