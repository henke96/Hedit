...
bin\debug-msvc.exe: $(headers) $(windows_main_sources)
	cl /Fe$@ /Fobin\ $(msvc_flags) $(msvc_debug_flags)$(windows_main_sources)

bin\release-msvc.exe: $(headers) $(windows_main_sources)
	cl /Fe$@ /Fobin\ $(msvc_flags) $(msvc_release_flags) $(windows_main_sources)
...
bin\test-msvc.exe: $(headers) $(windows_test_sources)
	cl /Fe$@ /Fobin\ $(msvc_flags) $(msvc_test_flags) $(windows_test_sources)
